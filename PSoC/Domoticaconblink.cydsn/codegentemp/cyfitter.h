...
/* PINMOV */
#define PINMOV__0__INTTYPE CYREG_PICU0_INTTYPE0
#define PINMOV__0__MASK 0x01u
#define PINMOV__0__PC CYREG_PRT0_PC0
#define PINMOV__0__PORT 0u
#define PINMOV__0__SHIFT 0u
#define PINMOV__AG CYREG_PRT0_AG
#define PINMOV__AMUX CYREG_PRT0_AMUX
#define PINMOV__BIE CYREG_PRT0_BIE
#define PINMOV__BIT_MASK CYREG_PRT0_BIT_MASK
#define PINMOV__BYP CYREG_PRT0_BYP
#define PINMOV__CTL CYREG_PRT0_CTL
#define PINMOV__DM0 CYREG_PRT0_DM0
#define PINMOV__DM1 CYREG_PRT0_DM1
#define PINMOV__DM2 CYREG_PRT0_DM2
#define PINMOV__DR CYREG_PRT0_DR
#define PINMOV__INP_DIS CYREG_PRT0_INP_DIS
#define PINMOV__INTSTAT CYREG_PICU0_INTSTAT
#define PINMOV__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU0_BASE
#define PINMOV__LCD_COM_SEG CYREG_PRT0_LCD_COM_SEG
#define PINMOV__LCD_EN CYREG_PRT0_LCD_EN
#define PINMOV__MASK 0x01u
#define PINMOV__PORT 0u
#define PINMOV__PRT CYREG_PRT0_PRT
#define PINMOV__PRTDSI__CAPS_SEL CYREG_PRT0_CAPS_SEL
#define PINMOV__PRTDSI__DBL_SYNC_IN CYREG_PRT0_DBL_SYNC_IN
#define PINMOV__PRTDSI__OE_SEL0 CYREG_PRT0_OE_SEL0
#define PINMOV__PRTDSI__OE_SEL1 CYREG_PRT0_OE_SEL1
#define PINMOV__PRTDSI__OUT_SEL0 CYREG_PRT0_OUT_SEL0
#define PINMOV__PRTDSI__OUT_SEL1 CYREG_PRT0_OUT_SEL1
#define PINMOV__PRTDSI__SYNC_OUT CYREG_PRT0_SYNC_OUT
#define PINMOV__PS CYREG_PRT0_PS
#define PINMOV__SHIFT 0u
#define PINMOV__SLW CYREG_PRT0_SLW
#define PINMOV__SNAP CYREG_PICU0_SNAP

/* ISR_MOV */
#define ISR_MOV__INTC_CLR_EN_REG CYREG_NVIC_CLRENA0
#define ISR_MOV__INTC_CLR_PD_REG CYREG_NVIC_CLRPEND0
#define ISR_MOV__INTC_MASK 0x02u
#define ISR_MOV__INTC_NUMBER 1u
#define ISR_MOV__INTC_PRIOR_NUM 7u
#define ISR_MOV__INTC_PRIOR_REG CYREG_NVIC_PRI_1
...
#define CY_PROJECT_NAME "Domoticaconblink"
