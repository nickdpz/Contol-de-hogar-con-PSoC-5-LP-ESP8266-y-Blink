...
*
* \funcusage
*  \snippet PINA_SUT.c usage_PINA_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet PINA_SUT.c usage_PINA_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet PINA_SUT.c usage_PINA_Read  
*******************************************************************************/
...
* preferred PINA_Read() API because the 
* PINA_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet PINA_SUT.c usage_PINA_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: PINA_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use PINA_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - PINA_0_INTR       (First pin in the list)
    *  - PINA_1_INTR       (Second pin in the list)
    *  - ...
    *  - PINA_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet PINA_SUT.c usage_PINA_SetInterruptMode
    *******************************************************************************/
    void PINA_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & PINA_0_INTR) != 0u) 
		{ 
			 PINA_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet PINA_SUT.c usage_PINA_ClearInterrupt
    *******************************************************************************/
